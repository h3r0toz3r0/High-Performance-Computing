// Code taken from https://gist.github.com/davidjpfeiffer/2bda83fbba570592e4d46d5e47853d32
...
int main(int argc, char *args[]){
   srand(time(NULL));
   // Modified by Anna DeVries from a Random Number to a set variable number
   int num_philosophers = 5; // getRandomNumber(25, 5);
...
void *philosopherCallback(void *arg){
   ...
   // Modified by Anna DeVries to represent a for loop with the states, limits to 10 iterations
   for(int i = 0; i < 10; i++){
   // End of code I modified
      think(philosopher);
...
void eat(philosopher_t *philosopher){
   ...
   // Added by Anna DeVries
   printf("Forks to the left and right of Philosopher %d are in use\n", philosopher->position + 1);
   // End of code I modified
   do{
      sleep(getRandomNumber(3, 1));
   } while (getRandomNumber(1, 0));
   ...
   // Added by Anna DeVries
   printf("Forks to the left and right of Philosopher %d are free\n", philosopher->position + 1);
   // End of code I modified
}
...
// End of code taken from https://gist.github.com/davidjpfeiffer/2bda83fbba570592e4d46d5e47853d32